...
CREATE_INGREDIENT_CATEGORY_400_RESPONSE = OpenApiResponse(
...
CREATE_INGREDIENT_CATEGORY_401_RESPONSE = OpenApiResponse(
    description="user is not authenticated"
)


CREATE_INGREDIENT_CATEGORY_403_RESPONSE = OpenApiResponse(
