...
class IngredientAdmin(BaseModelAdmin, NumericFilterModelAdmin):
    list_display = ["name", "category"] + BaseModelAdmin.list_display + ["remaining_units", "unit", "price"]
    list_editable = BaseModelAdmin.list_editable + ["remaining_units"]
    list_filter = BaseModelAdmin.list_filter + ["category", ("price", SliderNumericFilter),
