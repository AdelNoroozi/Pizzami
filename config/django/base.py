...
LOCAL_APPS = [
    ...
    'pizzami.feedback.apps.FeedbackConfig',
]
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'pizzami.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'pizzami.api.exception_handlers.hacksoft_proposed_exception_handler',
